			...
			do {
				...
				try {
					for (int i = 0; i < colCount; ++i) {
						...
						if(android.os.Build.VERSION.SDK_INT >= 11)
						{
							switch(cur.getType (i))
							{
								...
								case Cursor.FIELD_TYPE_BLOB:
									String base64 = android.util.Base64.encodeToString(cur.getBlob(i), android.util.Base64.DEFAULT);
									row.put(key, base64);
									break;
							}
						}
						...
						{
							row.put(key, cur.getString(i));
							Log.e("error", "Unsupported API Level: "+android.os.Build.VERSION.SDK_INT);
						}
					}
